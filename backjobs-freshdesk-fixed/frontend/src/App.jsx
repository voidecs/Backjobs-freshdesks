...
function CustomerPortal({ onSwitchManager }) {
  ...
  // Playful customer-facing status emojis
                      ...
                      >
                        <div className="ticket-row-main">
                          ...
                          <div className="ticket-info">
                            ...
                            <small>
                              <span className="customer-status-emoji">{statusEmoji(ticket.status)}</span>{" "}
          ...
          <section className="customer-section">
            ...
            {selectedTicket && (
              <div className="ticket-detail">
                ...
                <p>
                  <strong>Status:</strong> <span className="customer-status-emoji">{statusEmoji(selectedTicket.status)}</span>{" "}{statusName(selectedTicket.status)}
                  {" · "}
